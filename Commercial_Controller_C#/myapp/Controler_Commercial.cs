...
// ------------------- Class Battery ---------------------------
  class Battery{
    ...
    //     public Elevator AssignElevator(int requestedFloor, String direction, int userCurrentFloor){
    //     // calling function columnToFind
    //     Column columnFinded = this.columnToFind(requestedFloor);
    //     int floor = 1;
    //     // calling function ElevatorInTheChosenColumn
    ...
    // }
        // Find the the max and min floor by column
        // public int findColumnInBattery(int nbOfFloor){
        // // calcul to find the average floor by column
        // int averageFloorPerColumn = (nbOfFloor - nbOfBasement) / (nbOfColumnInBattery - 1);
        // int x = 1;
        // // repeat when x is less then the number of column
        // while (x < listColumnInBattery.Count){
        // // for each column in listColumnInBattery find the max and min floor
        // foreach (Column column in listColumnInBattery){

        // column.maxFloor = x * averageFloorPerColumn;
        // column.minFloor = column.maxFloor - averageFloorPerColumn;
        //    x = x + 1;
        //     }
        // }
        // return 0;
